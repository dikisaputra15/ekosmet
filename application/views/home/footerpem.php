<footer class="footer spad">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Sinar Kosmetik <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Colorlib</a>
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="<?= base_url(); ?>assets/shop-pages/img/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
