            ...
            <div class="row no-gutters">
               ...
               <div class="col-md-8">
                  ...
                  <div class="card-footer">
                     <div class="d-inline">
                        <button class="tambah_keranjang btn btn-sm btn-dark" data-gambar="<?= $barang['gambar']; ?>" data-produkid="<?= $barang['id_barang']; ?>" data-produknama="<?= $barang['nama_barang']; ?>" data-produkharga="<?= $barang['harga']; ?>">Keranjang</button>
